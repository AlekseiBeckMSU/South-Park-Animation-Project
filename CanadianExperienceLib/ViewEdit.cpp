...
/**
 * When edit move is clicked change mode to move
 * @param event
 */
...
/**
 * When edit rotate is clicked change mode to rotate
 * @param event
 */
...
/**
 * Check if current mode is rotate
 * @param event
 */
